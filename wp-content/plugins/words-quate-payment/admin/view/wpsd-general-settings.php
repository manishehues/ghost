            ...
            <form name="wpsd-general-settings-form" role="form" class="form-horizontal" method="post" action=""
                ...
                <table class="form-table">
                    <tr class="wpsd_donation_email">
                        <th scope="row">
                            <label
                                for="wpsd_donation_email"><?php _e('Words Pricing Quotes Email:', WPSD_TXT_DOMAIN); ?></label>
                        </th>
                        <td>
                            ...
                            <br>
                            <code>Words Pricing Quotes will send to this email.</code>
                        </td>
                    </tr>
                    ...
                    <tr class="wpsd_shortcode">
                        ...
                        <td>
                            <input type="text" name="wpsd_shortcode" id="wpsd_shortcode" class="regular-text" value="[wp_words_count_pricing_quote]" readonly />
                        </td>
                    </tr>
                </table>
