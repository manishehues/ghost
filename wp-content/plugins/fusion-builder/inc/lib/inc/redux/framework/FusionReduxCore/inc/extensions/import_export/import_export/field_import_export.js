            ...
            function() {
                ...
                el.each(
                    function() {
                        ...
                        $( this ).find( '#fusionredux-import-code-button' ).on( 'click',
                            function() {
                        ...
                        $( this ).find( '#fusionredux-import-link-button' ).on( 'click',
                            function() {
                        ...
                        $( this ).find( '#fusionredux-export-code-copy' ).on( 'click',
                            function() {
                        ...
                        $( this ).find( '#fusionredux-export-link' ).on( 'click',
                            function() {
